  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative z-10 text-center px-4 py-20 text-white max-w-3xl">
          ...
          <p className="text-lg leading-relaxed">
            आयुर्वेदिक तेल से सम्पूर्ण शरीर की मालिश, जो दोष संतुलन,
            तंत्रिका शिथिलता, त्वचा पोषण और मानसिक शांति प्रदान करती है।
          </p>
        </div>
      </section>
      ...
      <section className="px-4 py-10 max-w-3xl mx-auto space-y-6 text-gray-800">
        ...
        <p>
          अभ्यंग एक पारंपरिक आयुर्वेदिक तेल मालिश है जिसमें पूरे शरीर में गर्म हर्बल तेलों से सिर से पैर तक लयबद्ध तरीके से मालिश की जाती है।
          यह शरीर को शुद्ध करता है, रक्त संचार को बढ़ाता है और मानसिक तनाव को दूर करता है।
        </p>
        ...
        <ul className="list-disc pl-5 space-y-2">
          ...
          <li>10–25 मिनट तक तेल को सोखने दिया जाता है, फिर स्नान कराया जाता है।</li>
        </ul>
